...
func (b *boardStruct) genBishopMoves(ml moveList, sd colour) {
	sd = b.stm
...
func (b *boardStruct) genPawnMoves(ml moveList, sd colour) {
...
func (b *boardStruct) genAllMoves(ml *moveList, sd colour) {
